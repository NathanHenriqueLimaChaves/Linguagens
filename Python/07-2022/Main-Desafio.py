import os #Necessário importar biblioteca para usar o os.system

class bold_color:#Criado uma classe para ficar mais fácil usar os valores(cores) no código
   purple = '\033[95m'
   cyan = '\033[96m'
   darkCyan = '\033[36m'
   blue = '\033[94m'
...
print (bold_color.blue+'=================== Auto Mecânica '+ bold_color.bold + 'Gambiarra ===================')

while True:#ERRO(true com letra minúscula)
    print (bold_color.red+'1 - Clientes')
    print (bold_color.red+'2 - Estoque')
    print (bold_color.red+'3 - Vendas')
    print (bold_color.red+'4 - Colaboradores')
    print (bold_color.red+'5 - Ordem de Serviço')
    print (bold_color.red+'6 - Retorno')
    print (bold_color.red+'7 - Notas Fiscais')
    print (bold_color.red+'8 - Livro Caixa')
    print (bold_color.red+'0 - Sair')

    try:
        op=int(input(bold_color.green+'Selecione a Opção = '))
        os.system("cls")
        
        ###########Clientes##############
        if op==1:#ERRO(o número estava entre aspas) 
            while True:
                ...
                try :#ERRO(faltou dois pontos)
                    ...
                    if opCli==1:
                    ...
                    elif opCli==3:#ERRO(váriavel estava errada)
                        if nomeCliente!='':
                        ...
                        os.system("pause")
                        os.system("cls")
                        break#ERRO(break com letra maiúscula) 
        ...
        if op==2:
            while True:
                ...
                print (bold_color.red+'3 - Relatório de Produtos') #ERRO(print escrito errado)
                print (bold_color.red+'0 - Sair')
                ...
                try:
                    ...
                    elif opEst==3:#ERRO(elif escrito errado)
                        if descProduto!="":
                            print(bold_color.yellow+"=====Relatório do Cadastro de Cliente=====")
                ...
                except: #ERRO(except escrito errado)
                    os.system("cls")
                    print("Digite um valor válido")
                    os.system("pause")
                    os.system("cls")
            ...
            while True:
                ...
                try:
                    ...
                    if opVen==1:
                        ...
                        if vendaProduto!="":#ERRO(variável trocada)
            ...
            while True:
                ...
                try:
                    ...
                    if opColab==1:
                        ...
                        if nomeColab!="":#ERRO(variável trocada)
                            print(bold_color.yellow+"=====Relatório do Cadastro de Cliente=====")
                            ...
                            print(bold_color.bold + "Endereço do Colaborador = " + bold_color.bold + enderecoColab) 
                    ...
                    ##################Ordem de Serviço##############
        if op==5:
            while True: #ERRO(faltou endentação)
               ...
               try:
                    ...
                    elif opOs==2:#ERRO(varável estava trocada)
                    ...
                    elif opOs==3:#ERRO(variável estava trocada)
                        if nomeServ!="":
                            print(bold_color.yellow+"=====Relatório do Cadastro de Cliente=====")
                    ...
                    elif opOs==0:#ERRO(variável estava trocada)
                        os.system("cls")
                        print("Voltar - Menu Principal")
                        os.system("pause")
                        os.system("cls")
        ...
        if op==6:
            while True:
                ...
                try:
                    ...
                    elif opOs==2:#ERRO(variável estava trocada)
...
################ ##################### Livro Caixa ##############
        ...
        if op==8:#ERRO(número repetido)  
            while True:
                ...
                try:
                    opVen=int(input(bold_color.green+'Selecione a Opção = ')) #ERRO(input escrito errado)
                    os.system("cls")
                    if opVen==1:
